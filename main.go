...
func (w *Weather) checkStatus() (resWater string, resWind string) {
	...
	case w.Water > 8:
		resWater = "bahaya"
	default:
		resWater = "status water tidak ditemukan" // jika water dibawah 5, maka status nya "aman", jadi angka 5 masuk di kriteria "default"
	}
	...
	case w.Wind > 15:
		resWind = "bahaya"
	default:
		resWater = "status wind tidak ditemukan" // jika wind dibawah 6, maka status nya "aman", jadi angka 6 masuk di kriteria "default"
	}
